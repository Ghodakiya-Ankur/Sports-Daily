...
#     path('newcategory/', newcategory.as_view(), name='newcategory'),
#     # path('category/<str:cat>/', categorypage, name='category'),
#     # path('article/<slug:slug>/', DetailArticle.as_view(), name='detail-article'),
#     path('<cat>/<slug>/', DetailArticle.as_view(), name='detail-article'),
#     path('<str:cat>/', categorypage, name='category'),
# ]

# from django.urls import path
# from .views import home, newpost, updatepost, deletepost, newcategory, categorypage, DetailArticle
